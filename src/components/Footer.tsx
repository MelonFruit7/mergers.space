  ...
  return (
    <div className="h-[15vh] relative bg-[#000b2e] flex justify-between p-2 md:px-10">
      ...
      <div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <p className="text-gray-500 text-[1vh] text-center">
          @ {new Date().getFullYear()} Space Mergers, mergers.space
        </p>
      </div>

      <div className="flex flex-col items-center justify-center w-[50%] h-full">
        <a
          href="https://store.steampowered.com/app/2821220/Space_Mergers/"
          target="_blank"
          className="h-[60%] group"
        >
